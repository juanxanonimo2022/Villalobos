...
int main() {
  ...
  do {
    ...
    case 1:
      cout << "Ingresar datos del camion  : ";
    ...
    case 2:
      ...
      if (numero1 == cmn1.numero && cmn1.estado == 0 &&
        ...
        cmnestado = "Seleccionado";
               ...
               cargaatransportar <= cmn2.capacidad) {
        cout << "\n";
      ...
      else if (numero1 == cmn3.numero && cmn3.estado == 0 &&
               cargaatransportar <= cmn3.capacidad) {
        cout << "\n";
        cout << "Bien, el camion No " << numero1 << " puede llevar la carga"
             << "\n";
        cout << "\n";
      ...
      else if (numero1 == cmn4.numero && cmn4.estado == 0 &&
               cargaatransportar <= cmn4.capacidad) {
        cout << "\n";
        cout << "Bien, el camion No " << numero1 << " puede llevar la carga"
             << "\n";
        cout << "\n";
